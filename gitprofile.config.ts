    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ['ryanhulke/AVL', 'ryanhulke/LL', 'ryanhulke/ryanhulke.github.io'], // These projects will not be displayed. example: ['arifszn/my-project1', 'arifszn/my-project2']
        },
      },
      manual: {
